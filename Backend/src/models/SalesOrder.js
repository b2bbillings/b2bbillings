...
const salesOrderSchema = new mongoose.Schema(
  {
    ...
    // Source tracking (when this sales order was created from a purchase order)
    sourceOrderId: {
      type: mongoose.Schema.Types.ObjectId,
      default: null,
    },
    ...
    // ✅ NEW: Target company for bidirectional order generation
    targetCompanyId: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "Company",
      default: null,
    ...
    // ✅ NEW: Purchase order generation tracking
...
salesOrderSchema.index({targetCompanyId: 1}); // ✅ NEW: Index for targetCompanyId
...
salesOrderSchema.index({autoGeneratedPurchaseOrder: 1}); // ✅ NEW: Index for PO generation tracking
salesOrderSchema.index({hasGeneratedPurchaseOrder: 1}); // ✅ NEW: Index for PO generation tracking
salesOrderSchema.index({purchaseOrderRef: 1}); // ✅ NEW: Index for PO reference

// ✅ ESSENTIAL VIRTUAL FIELDS
...
// ✅ NEW: Virtual for bidirectional flow detection
salesOrderSchema.virtual("isBidirectionalSO").get(function () {
...
// ✅ ENHANCED: Pre-validate middleware to generate order number BEFORE validation
salesOrderSchema.pre("validate", async function (next) {
  // ============================================================================
  // STEP 1: GENERATE COMPANY-SPECIFIC SEQUENTIAL ORDER NUMBER (IF NEW)
  // ============================================================================
  if (this.isNew && !this.orderNumber) {
    try {
      console.log("🔢 Generating order number before validation...");
      ...
      // ✅ Find company-specific sequential number for today
      ...
      const lastOrder = await this.constructor
        .findOne({
          ...
          orderType: this.orderType, // ✅ Order type specific
          orderNumber: {
            $exists: true,
            $ne: null,
            $ne: "",
      ...
      if (lastOrder && lastOrder.orderNumber) {
        // Extract sequence from pattern: PREFIX-SO-[GST-]YYYYMMDD-XXXX
      ...
      // ✅ Generate company-specific order number
      ...
      console.log(
        `✅ Generated order number before validation: ${this.orderNumber}`,
        {
      ...
      console.log(`⚠️ Using fallback order number: ${this.orderNumber}`);
    }
  }
...
salesOrderSchema.pre("save", function (next) {
  // ============================================================================
  // STEP 2: SYNC GLOBAL TAX MODE FIELDS (after order number is set)
  // ============================================================================
  ...
  // ============================================================================
  // STEP 3: PROCESS ITEMS WITH ESSENTIAL FIELD MAPPING
  // ============================================================================
  this.items.forEach((item, index) => {
    ...
    // ✅ ESSENTIAL: Sync core prices only
    ...
    // ✅ ESSENTIAL: Sync discount fields
...
// ✅ NEW: Mark purchase order as generated
...
salesOrderSchema.methods.convertToInvoice = async function () {
  ...
  try {
    ...
    // Map items with proper field conversion
    ...
    const invoiceData = {
      ...
      // Payment info with advance transfer
      payment: {
    ...
    // Update this sales order with conversion info
...
// ✅ ESSENTIAL: Status management methods
...
// ✅ NEW: Get orders with generated purchase orders
