 ...
 * @desc    Get payment summary analytics (MISSING ROUTE)
 * @access  Private
 */
router.get(
...
// ==================== ENHANCED REPORTING ROUTES (ADD THESE) ====================

/**
 * @route   GET /api/sales/reports/bidirectional-summary
 * @desc    Get bidirectional integration summary report (ENHANCED)
 * @access  Private
 */
router.get(
  "/reports/bidirectional-summary",
...
/**
 * @route   GET /api/sales/export/bidirectional-csv
 * @desc    Export bidirectional sales data as CSV (ENHANCED)
 * @access  Private
 */
router.get(
  "/export/bidirectional-csv",
