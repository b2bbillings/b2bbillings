    ...
    try {
      ...
      const subtotal = validItems.reduce(
        (sum, row, idx) => {
          ...
          const gst = (amt * Number(gstValues[idx] || 0)) / 100;
          return sum + amt + gst;
        },
        0
      );
      ...
      const result = await invoiceService.createInvoice("purchase-with-gst", invoiceData);
      if (result && result.success !== false) {
        console.log("✅ Purchase invoice saved:", result);
