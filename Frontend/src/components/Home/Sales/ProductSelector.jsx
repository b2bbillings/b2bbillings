    ...
    return (
        <div className={`product-selector ${className}`} ref={dropdownRef}>
            <div className="position-relative">
                ...
                {showDropdown && (
                    <div className="product-dropdown position-absolute w-100 bg-white border rounded shadow-lg mt-1" style={{ zIndex: 1050, maxHeight: '300px', overflowY: 'auto' }}>
                                    ...
                                    >
                                        <div className="d-flex justify-content-between align-items-start">
                                            ...
                                            <div className="text-end">
                                                ...
                                                <small className="text-muted">
                                                    {product.isService ? 'Service' : `Stock: ${product.currentStock}`}
                                                </small>
                                            </div>
                                        </div>
                                    </ListGroup.Item>
