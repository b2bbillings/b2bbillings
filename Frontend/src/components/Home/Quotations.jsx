    ...
    <div className="quotations-main-container">
      ...
      <div className="quotations-content-scrollable">
        <Container fluid className="quotations-container">
          ...
          {/* Original Filters - Hidden (now in collapsible section) */}
          ...
          {/* Quotations Analysis Row */}
          <Row className="mb-4">
            <Col xs={12}>
              <div 
                className="quotations-analysis-wrapper"
                style={{
                  padding: '2rem',
      ...
      <style>{`
        ...
        /* Enhanced Quotations Analysis Wrapper */
        .quotations-analysis-wrapper {
          will-change: transform, box-shadow, border-color;
        }

        .quotations-analysis-wrapper:hover {
          background: linear-gradient(135deg, #fefefe 0%, #f8fafc 100%) !important;
        }

        .quotations-analysis-wrapper:hover::before {
          content: '';
          position: absolute;
          top: 0;
          left: 0;
        ...
        .quotations-analysis-wrapper h5,
        .quotations-analysis-wrapper h6 {
        ...
        .quotations-analysis-wrapper small {
        ...
        /* Enhanced card hover effects inside analysis wrapper */
        .quotations-analysis-wrapper:hover [style*="flex: '1 1 calc(33.333% - 0.75rem')"] {
          transform: translateY(-3px);
          box-shadow: 0 12px 30px rgba(0, 0, 0, 0.12);
        }

        .quotations-analysis-wrapper:hover [style*="flex: '1 1 calc(33.333% - 0.75rem')"] h5,
        .quotations-analysis-wrapper:hover [style*="flex: '1 1 calc(33.333% - 0.75rem')"] h6 {
        ...
        .quotations-analysis-wrapper {
          animation: quotationsPulseGlow 4s ease-in-out infinite;
        }
        ...
        .quotations-analysis-wrapper .text-muted {
          color: #64748b !important;
          font-weight: 500 !important;
        }

        .quotations-analysis-wrapper .text-dark {
          color: #1e293b !important;
          font-weight: 700 !important;
        }

        .quotations-analysis-wrapper .text-success {
          color: #059669 !important;
          font-weight: 700 !important;
        }

        .quotations-analysis-wrapper .text-warning {
          color: #d97706 !important;
          font-weight: 700 !important;
        }

        .quotations-analysis-wrapper .text-info {
