...
function TransactionHistory({
  ...
  return (
    <div className="transaction-history-container">
        ...
        >
          <div className="row align-items-center">
            <div className="col-md-6">
              ...
              <small className="text-white-50" style={{fontSize: "13px"}}>
            ...
            <div className="col-md-6">
              <div className="row g-2">
                <div className="col-md-8">
                  <InputGroup size="sm">
                    <InputGroup.Text
                      className="bg-white bg-opacity-25 border-white border-opacity-25 text-white"
          ...
          <div className="row g-2 mt-2">
            ...
            <div className="col-md-4">
              <Dropdown>
                ...
                <Dropdown.Menu style={{borderRadius: "0"}}>
                  <Dropdown.Item onClick={() => setDateRange("all")}>
                    All Time
                  </Dropdown.Item>
                  <Dropdown.Item onClick={() => setDateRange("today")}>
                    Today
                  </Dropdown.Item>
                  <Dropdown.Item onClick={() => setDateRange("week")}>
                    Last 7 Days
                  </Dropdown.Item>
                  <Dropdown.Item onClick={() => setDateRange("month")}>
                    Last Month
                  </Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
                  ...
                  <thead className="table-light sticky-top">
                    <tr>
                      ...
                      <th
                        ...
                        style={{minWidth: "90px", width: "90px"}}
                      >
                        <span style={{fontSize: "13px"}}>Method</span>
                      </th>
                      <th
                  ...
                  <tbody>
                    {transactions.length === 0 ? (
                      ...
                      transactions.map((transaction, index) => (
                        ...
                        >
                          {/* Date */}
                          <td className="border-0 px-2" style={{width: "90px"}}>
                            <div>
                              <span
                          ...
                          <td className="border-0 px-2" style={{width: "80px"}}>
                            <div className="d-flex align-items-center">
                              <FontAwesomeIcon
                                ...
                                className={`me-1 text-${getTransactionVariant(
                                  transaction.direction
                                )}`}
                                style={{fontSize: "12px"}}
                              />
                              <Badge
                                bg={getTransactionVariant(
                                  transaction.direction
                                )}
                                text="white"
                          ...
                          {/* Method */}
                          <td
                            className="border-0 px-2 d-none d-md-table-cell"
                            style={{width: "90px"}}
                          >
                            <Badge
                              bg="light"
                              ...
                              style={{fontSize: "11px", borderRadius: "0"}}
                            >
                              {transaction.paymentMethod?.length > 10
                                ? `${transaction.paymentMethod.substring(
                                    0,
                                    10
                                  )}...`
                          ...
                          {/* Amount */}
                          <td
                            className="border-0 text-end px-2"
                            style={{width: "100px"}}
                          >
                            <div
                              className={`fw-bold ${
                          ...
                          {/* Balance */}
                          <td
                            className="border-0 text-end px-2 d-none d-lg-table-cell"
                            style={{width: "100px"}}
                          >
                            <div
                          ...
                          {/* Status */}
                          <td
                            className="border-0 text-center px-2"
                            style={{width: "80px"}}
                          >
                            <Badge
                              bg={
                ...
                <div className="row text-center small">
                  <div className="col-6">
                    ...
                    <small className="text-muted" style={{fontSize: "12px"}}>
                      Credits ({stats.creditCount}) - Current Page
                    </small>
                  </div>
                  <div className="col-6">
                    <div
                    ...
                    <small className="text-muted" style={{fontSize: "12px"}}>
                      Debits ({stats.debitCount}) - Current Page
                    </small>
                  </div>
                </div>
              </div>
      ...
      <style>
        {`
          .transaction-history-container .card,
          .transaction-history-container .card-header,
          .transaction-history-container .card-body,
          .transaction-history-container .card-footer {
            border-radius: 0 !important;
          }
          
          .transaction-history-container .btn,
          .transaction-history-container .form-control,
          .transaction-history-container .form-select,
          .transaction-history-container .input-group-text,
          .transaction-history-container .badge,
          .transaction-history-container .dropdown-menu {
            border-radius: 0 !important;
          }
          
          .transaction-history-container .pagination .page-link {
            border-radius: 0 !important;
          }
