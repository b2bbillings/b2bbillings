                ...
                <Form onSubmit={handleSubmit}>
                            ...
                            <Row>
                                <Col xs={4}>
                                    <div className="text-center">
                                        ...
                                        <div className="fw-semibold">{product.currentStock || 0}</div>
                                    </div>
                                </Col>
                                <Col xs={4}>
                                    <div className="text-center">
                                        <div className="text-muted small">Change</div>
                                        <div className={`fw-semibold ${adjustmentType === 'add' ? 'text-success' : adjustmentType === 'remove' ? 'text-danger' : 'text-info'}`}>
                                            {adjustmentType === 'add' && '+'}
                    ...
                    {newStock < 0 && (
                        <Alert variant="warning" className="mt-3">
                            <small>
                                <strong>Warning:</strong> This adjustment will result in negative stock.
                            </small>
                        </Alert>
                    )}
                    ...
                    {newStock > 0 && newStock <= product.minStockLevel && (
                        <Alert variant="info" className="mt-3">
                            <small>
                                <strong>Note:</strong> Stock will be below minimum level ({product.minStockLevel} {product.unit}).
                            </small>
                        </Alert>
                    )}
