...
function PurchasesSummaryCards({ purchases }) {
    ...
    const completedPurchases = purchases.filter(purchase => purchase.status === 'received').length;
                ...
                <Card className="summary-card border-left-primary">
                    <Card.Body>
                        <div className="d-flex align-items-center">
                            <div className="me-3">
                                <FontAwesomeIcon icon={faShoppingBag} className="text-primary fa-2x" />
                            </div>
                            <div>
            ...
            <Col md={3}>
                <Card className="summary-card border-left-info">
                    <Card.Body>
                        <div className="d-flex align-items-center">
                            <div className="me-3">
                                <FontAwesomeIcon icon={faCheckCircle} className="text-info fa-2x" />
                            </div>
                            <div>
            ...
            <Col md={3}>
                <Card className="summary-card border-left-warning">
                    <Card.Body>
                        <div className="d-flex align-items-center">
                            <div className="me-3">
                                <FontAwesomeIcon icon={faClockRotateLeft} className="text-warning fa-2x" />
                            </div>
                            <div>
