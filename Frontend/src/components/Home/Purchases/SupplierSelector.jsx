    ...
    useEffect(() => {
        if (inputValue.trim()) {
            const filtered = suppliers.filter(supplier =>
                ...
                (supplier.gstNumber && supplier.gstNumber.toLowerCase().includes(inputValue.toLowerCase()))
            );
    ...
    return (
        <div className="position-relative">
            <Form.Control
                ...
                onFocus={() => inputValue && setShowSuggestions(filteredSuppliers.length > 0)}
                        ...
                        {filteredSuppliers.map((supplier) => (
                            ...
                            >
                                ...
                                <div className="small text-muted">
                                    {supplier.phone && <span className="me-3">📞 {supplier.phone}</span>}
                                    {supplier.city && <span className="me-3">📍 {supplier.city}</span>}
